    ...
    public class SnapGame
    {
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			if (myGame.IsStarted)
			{
				...
				{
					SwinGame.LoadSoundEffectNamed ("Crash", "Car+Crash.wav");
					SwinGame.PlaySoundEffect ("Crash");
					myGame.PlayerHit (1);
				}
			} 
		}
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Testing ONE - Top Card is " + top.ToString (), Color.RoyalBlue, 0, 20);
				SwinGame.DrawText ("Testing ONE - Player 1 score: " + myGame.Score(0), Color.RoyalBlue, 0, 30);
				SwinGame.DrawText ("Testing ONE - Player 2 score: " + myGame.Score(1), Color.RoyalBlue, 0, 40);
